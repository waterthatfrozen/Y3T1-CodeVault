...
--
-- Host: localhost
-- Generation Time: Nov 01, 2021 at 02:14 AM
...
CREATE TABLE `new_order` (
  `ORD_NUM` decimal(6,0) DEFAULT NULL,
  `NEW_AMT` decimal(12,2) DEFAULT NULL
...
INSERT INTO `new_order` (`ORD_NUM`, `NEW_AMT`) VALUES
('200100', '1600.00'),
('200110', '3500.00'),
('200107', '5400.00'),
('200112', '2400.00'),
...
('200107', '4500.00', '900.00', '2008-08-30', 'C00007', 'A010  ', 'SOD\r'),
('200112', '10000.00', '5000.00', '2008-05-30', 'C00016', 'A007  ', 'SOD\r'),
...
('200124', '10000.00', '5000.00', '2008-06-20', 'C00017', 'A007  ', 'SOD\r'),
...
('200128', '3500.00', '1500.00', '2008-07-20', 'C00009', 'A002  ', 'SOD\r'),
('200135', '2010.00', '800.00', '2008-09-16', 'C00007', 'A010  ', 'SOD'),
...
INSERT INTO `user` (`title`, `first_name`, `last_name`, `email`, `usergroup`, `disabled`, `level`) VALUES
('Mr', 'James', 'Bahn', 'james@bahn.com', 'student', 0, 4),
('Mr', 'James', 'Ball', 'james@ball.com', 'student', 0, 3),
('Ms', 'Jane', 'Doe', 'jane@doe.com', 'teacher', 1, 3),
('Ms', 'Jane', 'Jungle', 'jane@jungle.com', 'student', 1, 1),
('Mr', 'John', 'Doe', 'john@doe.com', 'teacher', 0, 1),
(NULL, NULL, NULL, 'test2@test.com', NULL, NULL, 1),
(NULL, 'Unknown', NULL, 'test3@test.com', 'student', NULL, 1),
(NULL, NULL, NULL, 'test@test.com', NULL, NULL, 1);
