...
<div id="wrapper"> 
	<div id="div_header" class="color-change-2x">
		CSS326 System 
	</div>
	<div id="div_subhead">
		<ul id="menu">
	...
	<div id="div_main">
		...
		<div id="div_content" class="usergroup sunset bg-pan-bl">
			<!--%%%%% Main block %%%%-->
			...
			<table>
                ...
                if ($result){
                  while($row=$result->fetch_array()){
                    ...
                    echo '<img class="rotate-in-center" src="images/Delete.png" width="24" height="24"></td>';
                    echo '</tr>';
                  }
                } else {
