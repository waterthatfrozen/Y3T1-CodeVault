...
def get_image(image_name):
    try:
        return send_from_directory("./static/frontend/img/", image_name)
...
def get_css(css_name):
    try:
        return send_from_directory("./static/frontend/css/", css_name)
    except FileNotFoundError:
        abort(404)
...
@app.route("/catalog")
def catalog():
    return app.send_static_file("./frontend/catalog.html")

@app.route("/store")
def store():
    return app.send_static_file("./frontend/store.html")

@app.route("/item")
def itempage():
    return app.send_static_file("./frontend/item.html")
